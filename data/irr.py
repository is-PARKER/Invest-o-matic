...
class IRR(Base):
    ...
    # return_array = sqlalchemy.Column(sqlalchemy.ARRAY(sqlalchemy.Float),nullable=False)
    # invest_array = sqlalchemy.Column(sqlalchemy.ARRAY(sqlalchemy.Float),nullable=False)
    # irr_array = sqlalchemy.Column(sqlalchemy.ARRAY(sqlalchemy.Float),nullable=False)
